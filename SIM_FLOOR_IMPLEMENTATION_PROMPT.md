Develop a full-stack Sim Floor mock-call module inside the current codebase and align it to the existing trainer, trainee, KPI, analytics, coaching, reporting, and certificate flows.
