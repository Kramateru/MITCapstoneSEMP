# Microlearning Full Stack Implementation Prompt

Develop a full-stack Microlearning module inside the current codebase and align it to the existing trainer, trainee, analytics, reporting, certificate, and Supabase flows.
...
Create at least 10 default modules with answers. Include these default themes:

1. HEARD De-escalation Toolkit
2. Robotic vs Empathetic Tone
3. API Reset Playbook
4. Power Phrases vs Wall Phrases
5. 1-Star Review Recovery Analysis
6. Grammar Rescue: Subject-Verb Agreement
7. Escalation Update Sentence Builder
8. Technical Term Pronunciation Drill
9. Active Listening Power Phrase Board
10. Billing Dispute Root Cause Review
