...
import { getCallSimulationImplementationPrompt } from '@/app/lib/assessment/call-simulation-implementation-prompt'

export async function GET() {
  return NextResponse.json({
    title: 'Call Simulation Full Stack Implementation Prompt',
    source: 'frontend/app/lib/assessment/call-simulation-implementation-prompt.ts',
    prompt: getCallSimulationImplementationPrompt(),
    notes: [
