    ...
    return (
      <Card className="border-rose-200 bg-rose-50/50">
        <CardContent className="flex items-center gap-3 py-6 text-sm text-rose-700">
          <LazyIcon name="AlertCircle" className="size-4 flex-shrink-0" />
          {error}
        </CardContent>
      </Card>
    );
    ...
    <div className="space-y-4">
      ...
      {filteredTrainees.length === 0 ? (
        <Card className="border-border/70 bg-card/90">
            ...
            <LazyIcon name="Users" className="mx-auto mb-3 size-8 opacity-30" />
                ...
                <div className="flex-1 space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant={trainee.is_active ? 'default' : 'secondary'}>
                      {trainee.is_active ? (
                        <>
                          <LazyIcon name="CheckCircle" className="mr-1 size-3" />
                          Active
                        </>
                      ) : (
                        <>
                          <LazyIcon name="AlertCircle" className="mr-1 size-3" />
                          Inactive
                        </>
                      )}
                    </Badge>
