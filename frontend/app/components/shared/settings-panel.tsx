      ...
      {loading ? (
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1.6fr)_320px]">
          <div className="space-y-6">
            <Card className="border-border/70 bg-card/90 shadow-sm">
                ...
                <CardTitle className="flex items-center gap-2">
                  <LazyIcon name="Layout" className="size-5 text-primary" />
                  Layout Settings
                </CardTitle>
            ...
            <Card className="border-border/70 bg-card/90 shadow-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <LazyIcon name="Eye" className="size-5 text-primary" />
                  Accessibility
                </CardTitle>
            ...
            <Card className="border-border/70 bg-card/90 shadow-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <LazyIcon name="Palette" className="size-5 text-primary" />
                  Theme & Typography
                </CardTitle>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
                    <LazyIcon name="Type" className="size-4 text-primary" />
                    Global Font Size
                  </div>
          ...
          <Card className="h-fit border-border/70 bg-card/95 shadow-sm xl:sticky xl:top-6">
                <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <LazyIcon name="Settings" className="size-5 text-primary" />
                Settings Overview
              </CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex flex-col gap-3">
                <Button type="button" variant="outline" onClick={handleReset} disabled={saving}>
                  <LazyIcon name="RefreshCw" className="mr-2 size-4" />
                  Reset Settings
                </Button>
                <Button type="button" onClick={handleSave} disabled={saving}>
                  {saving ? <LazyIcon name="Loader2" className="mr-2 size-4 animate-spin" /> : <LazyIcon name="Save" className="mr-2 size-4" />}
                  Save Changes
                </Button>
              </div>
            </CardContent>
