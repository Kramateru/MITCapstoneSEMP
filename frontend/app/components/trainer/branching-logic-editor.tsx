...
const GitBranch = (props: any) => <LazyIcon name="GitBranch" {...props} />;
const Plus = (props: any) => <LazyIcon name="Plus" {...props} />;
const Trash2 = (props: any) => <LazyIcon name="Trash2" {...props} />;
const MessageCircle = (props: any) => <LazyIcon name="MessageCircle" {...props} />;
const User = (props: any) => <LazyIcon name="User" {...props} />;
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent size="xl" className="flex max-h-[90vh] flex-col overflow-hidden">
        ...
        <div className="grid min-h-0 flex-1 gap-6 overflow-y-auto lg:grid-cols-[minmax(0,1fr)_minmax(20rem,0.42fr)]">
          {/* Flow Visualization Panel */}
          <div className="min-w-0 overflow-y-auto rounded-lg border p-4">
          ...
          {/* Node Editor Panel */}
          <div className="min-w-0 space-y-4 overflow-y-auto rounded-lg border p-4">
            {selectedNode ? (
              <>
                <div>
