...
import {
    ...
    XAxis,
    YAxis,
} from '../ui/chart.recharts'

const Activity = (props: any) => <LazyIcon name="Activity" {...props} />
const AlertTriangle = (props: any) => <LazyIcon name="AlertTriangle" {...props} />
const GraduationCap = (props: any) => <LazyIcon name="GraduationCap" {...props} />
const Loader2 = (props: any) => <LazyIcon name="Loader2" {...props} />
const MessageSquare = (props: any) => <LazyIcon name="MessageSquare" {...props} />
        ...
        <>
          <div className="analytics-summary-grid">
            ...
            <SummaryCard
              ...
              icon={<LazyIcon name="ClipboardList" className="size-5 text-amber-600" />}
            />
            <SummaryCard
              ...
              icon={<LazyIcon name="Gauge" className="size-5 text-cyan-600" />}
            />
            <SummaryCard
              label="Avg Call KPI"
              ...
              icon={<LazyIcon name="Mic" className="size-5 text-violet-600" />}
            />
            <SummaryCard
              label="Pass Rate"
