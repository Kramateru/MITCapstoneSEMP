      ...
      <CardHeader className="space-y-3">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {saveState === 'saving' ? (
                <span className="inline-flex items-center gap-1">
                  <LazyIcon name="Loader2" className="size-3 animate-spin" />
                  Saving
                </span>
              ) : saveState === 'saved' ? (
                'Saved'
            ...
            <div className="flex items-center gap-2">
              <button type="button" onClick={() => {/* add new option logic maybe */}}>
                <LazyIcon name="Plus" className="size-4" />
              </button>
              <button type="button" onClick={() => onDelete(question.id)}>
                <LazyIcon name="Trash2" className="size-4 text-rose-600" />
              </button>
            </div>
            <Button
              type="button"
      ...
      <CardContent className="space-y-4">
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs text-slate-600">
          <div className="flex items-center gap-2 font-semibold text-slate-700">
            <LazyIcon name="Save" className="size-3.5" />
            Live modify mode
          </div>
          <p className="mt-1">
