...
const Award = (props: any) => <LazyIcon name="Award" {...props} />
const BarChart3 = (props: any) => <LazyIcon name="BarChart3" {...props} />
const BookOpenCheck = (props: any) => <LazyIcon name="BookOpenCheck" {...props} />
const CheckCircle2 = (props: any) => <LazyIcon name="CheckCircle2" {...props} />
const ClipboardList = (props: any) => <LazyIcon name="ClipboardList" {...props} />
const Download = (props: any) => <LazyIcon name="Download" {...props} />
const Loader2 = (props: any) => <LazyIcon name="Loader2" {...props} />
const MessageSquarePlus = (props: any) => <LazyIcon name="MessageSquarePlus" {...props} />
...
const Sparkles = (props: any) => <LazyIcon name="Sparkles" {...props} />
const Target = (props: any) => <LazyIcon name="Target" {...props} />
const Trash2 = (props: any) => <LazyIcon name="Trash2" {...props} />
const Upload = (props: any) => <LazyIcon name="Upload" {...props} />
const Users = (props: any) => <LazyIcon name="Users" {...props} />
...
import { isAssessmentServiceAuthError } from '@/app/lib/assessment/error-utils'
...
export function TrainerAssessmentStudio({
    ...
    return (
      <Card className="border-amber-200 bg-amber-50/80">
        ...
        <CardContent>
          ...
          <Button type="button" className="mt-3" onClick={() => void refreshWorkspace('refresh')} disabled={refreshing}>
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="rounded-2xl border border-sky-200 bg-sky-50 px-3 py-3 text-sm text-sky-700">
        {liveStatus}
      </div>
      ...
      <section id={SECTION_ANCHORS.overview} className="scroll-mt-24 space-y-3">
        ...
        <div className="grid gap-3 xl:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
          <Card className="border-slate-200 shadow-sm">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="rounded-3xl border border-dashed border-slate-300 bg-white p-3">
                ...
                <div className="mt-3 space-y-3">
                  {recentAssignments.length ? recentAssignments.map((assignment) => (
                    <div key={assignment.id} className="flex flex-col gap-2 rounded-2xl border border-slate-200 bg-slate-50/70 px-3 py-3 lg:flex-row lg:items-center lg:justify-between">
                      <div>
      ...
      <section id={SECTION_ANCHORS.builder} className="scroll-mt-24 space-y-3">
        <div className="space-y-1">
                ...
                {selectedCategory.assessments.length ? (
                  <div className="space-y-3">
                    {selectedCategory.assessments.map((assessment) => {
                      ...
                      return (
                        <div key={assessment.id} className="rounded-3xl border border-slate-200 bg-slate-50/70 p-3">
                          <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                            <div className="space-y-2">
      ...
      <section id={SECTION_ANCHORS.questions} className="scroll-mt-24 space-y-3">
        <div className="space-y-1">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              {!paginatedQuestions.length ? (
                <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-3 py-3 text-sm text-slate-600">
      ...
      <section id={SECTION_ANCHORS['bulk-upload']} className="scroll-mt-24 space-y-3">
        <div className="space-y-1">
        ...
        <div className="grid gap-3 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
          <Card className="border-slate-200 shadow-sm">
            <CardHeader>
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between lg:gap-5">
                ...
                <Button type="button" variant="outline" onClick={() => void handleDownloadQuestionTemplate()} className="shrink-0">
                  <Download className="size-4" />
                  Download Template
                </Button>
              </div>
            ...
            <CardContent className="space-y-3">
              <div className="rounded-3xl border border-dashed border-slate-300 bg-slate-50/80 p-3">
                  ...
                  {bulkUploadResult.importedQuestions.length ? (
                    <div className="space-y-3">
                      ...
                      {bulkUploadResult.importedQuestions.slice(0, 5).map((question) => (
                        <div key={question.id} className="rounded-2xl border border-slate-200 bg-slate-50/70 px-3 py-2">
          ...
          <Card className="border-slate-200 shadow-sm">
            ...
            <CardContent className="space-y-3">
              <div className="rounded-3xl border border-slate-200 bg-slate-50/80 p-3 text-sm text-slate-700">
              ...
              {bulkUploadResult?.errors.length ? (
                <div className="space-y-3">
                  ...
                  {bulkUploadResult.errors.slice(0, 8).map((errorRecord) => (
                    <div key={`${errorRecord.rowNumber}-${errorRecord.questionNumber}-${errorRecord.error}`} className="rounded-2xl border border-rose-200 bg-rose-50 px-3 py-3 text-sm text-rose-700">
                      Row {errorRecord.rowNumber} | {errorRecord.category || 'No category'} | Q{errorRecord.questionNumber || '?'}: {errorRecord.error}
                    </div>
                  ))}
                </div>
              ) : (
                <div className="rounded-3xl border border-dashed border-slate-300 bg-white px-3 py-3 text-sm text-slate-600">
      ...
      <section id={SECTION_ANCHORS['assessment-list']} className="scroll-mt-24 space-y-3">
        <div className="space-y-1">
        ...
        <Card>
          <CardHeader>
            <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between xl:gap-5">
              ...
              <Button type="button" onClick={() => openAssessmentDialog(undefined, selectedCategoryId || categories[0]?.id || '')} className="shrink-0">
                <Plus className="size-4" />
                New Assessment
              </Button>
            </div>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-3">
              {paginatedAssessmentLibrary.map(({ assessment, category, questionCount, assignmentCount }) => (
                <div key={assessment.id} className="rounded-2xl border border-slate-200 p-3">
                  <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
                    <div className="space-y-2">
                      <div className="flex flex-wrap items-center gap-2">
                        <div className="font-semibold text-slate-950">{assessment.title}</div>
      ...
      <section id={SECTION_ANCHORS.assign} className="scroll-mt-24 space-y-3">
        <div className="space-y-1">
          ...
          <Card className="border-slate-200 shadow-sm lg:col-span-2">
            <CardHeader>
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between lg:gap-3">
                ...
                <Button type="button" onClick={() => openAssignmentDialog(undefined, selectedCategory?.id || categories[0]?.id || '', selectedCategory?.assessments[0]?.id || '')} className="shrink-0">
                  <Plus className="size-4" />
                  Create Assignment
                </Button>
              </div>
            ...
            <CardContent className="space-y-3">
              <div className="rounded-3xl border border-slate-200 bg-slate-50/80 p-3">
                <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between lg:gap-3">
                  ...
                  {selectedCategory ? (
                    <Badge variant="outline" className="shrink-0">{selectedCategory.assessments.length} assessments ready</Badge>
                  ) : null}
                </div>
                <div className="mt-4 grid gap-3 md:grid-cols-3 items-center">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="rounded-3xl border border-slate-200 bg-white p-3 h-full flex flex-col justify-between">
      ...
      <section id={SECTION_ANCHORS['assignment-status']} className="scroll-mt-24 space-y-3">
        <div className="space-y-1">
        ...
        <Card>
          <CardHeader>
            <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between xl:gap-5">
              ...
              <Button type="button" onClick={() => openAssignmentDialog()} className="shrink-0">
                <Plus className="size-4" />
                New Assignment
              </Button>
            </div>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-3">
              {paginatedAssignments.map((assignment) => (
                <div key={assignment.id} className="rounded-2xl border border-slate-200 p-3">
                  <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between xl:gap-5">
                    <div className="min-w-0 flex-1 space-y-2">
                      <div className="flex flex-wrap items-center gap-2">
      ...
      <section id={SECTION_ANCHORS.results} className="scroll-mt-24 space-y-3">
        <div className="space-y-1">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-3">
              {paginatedAttempts.map((attempt) => (
                <div key={attempt.id} className="rounded-2xl border border-slate-200 p-3">
                  <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
                    <div className="space-y-2">
                      <div className="flex flex-wrap items-center gap-2">
                ...
                <ScrollArea className="mt-4 h-[260px] pr-4">
                  <div className="space-y-3">
                    {filteredAssignmentPoolQuestions.map((question) => {
                      ...
                      return (
                        <label key={question.id} className="flex items-start gap-3 rounded-2xl border border-slate-200 p-3">
                          <Checkbox
                            checked={isChecked}
