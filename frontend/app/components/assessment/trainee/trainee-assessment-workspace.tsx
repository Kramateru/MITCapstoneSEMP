...
const ArrowRight = (props: any) => <LazyIcon name="ArrowRight" {...props} />
      ...
      <Card className="border-slate-200 shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          {!filteredAssessments.length ? (
            ...
            <div className="grid gap-3 2xl:grid-cols-[minmax(0,360px)_minmax(0,1fr)]">
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          ...
                          void loadAssessmentSession(assessment.assignmentId, { displayMode: 'overview' })
                        }}
...
function FocusedAssessmentCard({
  ...
  return (
    <div className="rounded-[28px] border border-slate-200 bg-[radial-gradient(circle_at_top_right,rgba(224,242,254,0.7),transparent_32%),linear-gradient(160deg,rgba(255,255,255,0.99),rgba(248,250,252,0.98))] p-4 shadow-sm sm:p-5">
