        ...
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                'group rounded-[28px] border bg-white p-5 text-left shadow-sm transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2',
                isActive
