...
const alertDialogSizeClasses: Record<AlertDialogContentSize, string> = {
  sm: "!w-[95vw] sm:!w-[88vw] lg:!w-[75vw] lg:!max-w-[920px] 2xl:!max-w-[1040px]",
  md: "!w-[95vw] sm:!w-[88vw] lg:!w-[78vw] lg:!max-w-[1060px] 2xl:!max-w-[1180px]",
  lg: "!w-[95vw] sm:!w-[90vw] lg:!w-[80vw] lg:!max-w-[1220px] 2xl:!max-w-[1340px]",
  xl: "!w-[96vw] sm:!w-[92vw] lg:!w-[82vw] lg:!max-w-[1400px] 2xl:!max-w-[1520px]",
};
