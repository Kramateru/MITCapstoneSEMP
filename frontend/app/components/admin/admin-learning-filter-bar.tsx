    ...
    <div className="rounded-[1.75rem] border border-border/80 bg-white/92 p-4 shadow-[0_18px_42px_-34px_rgba(15,23,42,0.24)] backdrop-blur sm:p-5 lg:p-6">
      <div className="dashboard-form-grid">
        ...
        <div className="dashboard-form-actions">
          <Button type="button" variant="outline" className="min-h-11 w-full lg:w-auto" onClick={() => onChange(EMPTY_ADMIN_LEARNING_FILTERS)}>
            <LazyIcon name="FilterX" className="mr-2 size-4" />
            Clear Filters
          </Button>
        </div>
      </div>
