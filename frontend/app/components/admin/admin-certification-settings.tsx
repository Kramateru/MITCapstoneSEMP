    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            {saving ? <LazyIcon name="Loader2" className="size-4 animate-spin" /> : <LazyIcon name="Save" className="size-4" />}
          ...
          <Button
            ...
            className="rounded-full"
          >
            <LazyIcon name="Edit3" className="size-4" />
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <AssetUploadCard
                ...
                fallbackIcon={<LazyIcon name="ImagePlus" className="size-5" />}
                editable={isEditing}
              />
              <AssetUploadCard
                ...
                fallbackIcon={<LazyIcon name="Upload" className="size-5" />}
                editable={isEditing}
              />
            </div>
          </CardContent>
...
function AssetUploadCard({
  ...
  return (
    <div className="rounded-2xl border border-dashed border-slate-300 p-4">
      ...
      >
        <LazyIcon name="Upload" className="size-4" />
        Upload Image
      </Label>
      <input
        id={inputId}
