...
const ChevronLeft = (props: any) => <LazyIcon name="ChevronLeft" {...props} />;
const ChevronRight = (props: any) => <LazyIcon name="ChevronRight" {...props} />;
const CircleDashed = (props: any) => <LazyIcon name="CircleDashed" {...props} />;
...
function TimedFlashcardSessionCard({
  ...
  const triggerAutoSubmit = useCallback((nextStatus: 'timed_out' | 'unanswered') => {
