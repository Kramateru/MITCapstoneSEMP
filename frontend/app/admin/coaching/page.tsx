        ...
        <section className="rounded-[2rem] border border-border bg-card/95 p-5 shadow-sm sm:p-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-3">
              ...
              <div>
                <h2 className="text-balance text-[clamp(1.85rem,1.25rem+1vw,2.8rem)] font-bold tracking-normal text-foreground">
            ...
            <Button type="button" variant="outline" onClick={() => void load()} disabled={isLoading}>
              {isLoading ? <LazyIcon name="Loader2" className="size-4 animate-spin" /> : <LazyIcon name="RefreshCw" className="size-4" />}
          ...
          <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <Button type="button" onClick={() => void saveTemplate()} disabled={isSaving}>
              {isSaving ? (
                ...
                <LazyIcon name="Save" className="mr-2 size-4" />
              )}
              Save Template
            </Button>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    ...
                    {isChecked ? (
                      <LazyIcon name="CheckCircle2" className="size-4 text-emerald-600" />
                    ) : (
