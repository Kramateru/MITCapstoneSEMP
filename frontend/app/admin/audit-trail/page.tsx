...
const UserCheck = (props: any) => <LazyIcon name="UserCheck" {...props} />;
  ...
  return (
    <DashboardLayout sidebarItems={adminSidebarItems} userRole="admin">
      <div className="space-y-6">
        ...
        <div className="dashboard-five-grid">
        ...
        <div className="data-card p-5">
          ...
          <div className="dashboard-form-grid mt-5">
          ...
          <div className="table-scroll-area mt-5 rounded-xl border border-border">
