...
const ADMIN_QUICK_LINKS = [
  {
    ...
    icon: (props: any) => <LazyIcon name="Users" {...props} />,
    tone: 'blue' as const,
  },
  {
    ...
    icon: (props: any) => <LazyIcon name="Activity" {...props} />,
  ...
  },
  {
    ...
    icon: (props: any) => <LazyIcon name="MessageSquare" {...props} />,
    tone: 'amber' as const,
  },
  {
    ...
    icon: (props: any) => <LazyIcon name="ShieldCheck" {...props} />,
    tone: 'green' as const,
  },
] as const;
      ...
      <div className="space-y-4 lg:space-y-4">
        <DashboardHero
          ...
          actions={
              ...
              {refreshing ? <LazyIcon name="Loader2" className="size-4 animate-spin" /> : <LazyIcon name="RefreshCw" className="size-4" />}
              Refresh
            </Button>
          }
        >
        ...
        <div className="dashboard-metrics-grid">
          ...
          <MetricCard
            ...
            icon={<LazyIcon name="UserCheck" className="size-5" />}
            tone="green"
          />
          <MetricCard
            ...
            icon={<LazyIcon name="Activity" className="size-5" />}
            tone="violet"
          />
          <MetricCard
            label="Average Score"
