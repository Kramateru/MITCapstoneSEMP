...
export const trainerSidebarItems = (pendingReviews?: number) => [
  ...
  { label: 'Assessment', icon: <BookOpenCheck size={20} />, href: '/trainer/assessments' },
  { label: 'Microlearning', icon: <BookOpen size={20} />, href: '/trainer/microlearning' },
  { label: 'Sim Floor', icon: <Mic size={20} />, href: '/trainer/sim-floor' },
